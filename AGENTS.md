# Agent guide for the PneumaticCraft: Repressurized BlueMap add-on
...
- Exact profile `pneumaticcraft-8.2.23-mc1.21.1`
...
- `-PpneumaticCraftJar=/path/to/pneumaticcraft-repressurized-8.2.23+mc1.21.1.jar`
