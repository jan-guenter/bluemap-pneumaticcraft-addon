...
| PneumaticCraft: Repressurized profile | `pneumaticcraft-8.2.23-mc1.21.1` | See `provenance/upstreams.json` | Exact installed-artifact and resource evidence only | No |
